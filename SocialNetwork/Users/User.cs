...
namespace Social_Network
{
    class User : AbstractUser
    {
        ...
        {
            User curr = new User(firstName, lastName, email, gender, userName, password, fGenre);
        ...
        {
            Post post = new Post(content, this.UserName, 3);
        ...
        {
            return dataBase.ShowPlaylistByGenres(genre, "0");
        }
